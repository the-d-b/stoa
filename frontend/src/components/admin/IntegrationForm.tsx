...
export const INTEGRATION_TYPES = [
  ...
  { id: 'homebox',   label: 'Homebox',   desc: 'Home inventory — URL is http://homebox:7745. API key field: an API token from Homebox → Profile → API Tokens (recommended), or email:password of your Homebox account.', category: 'Digital Life' },
