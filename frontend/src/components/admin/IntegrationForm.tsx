...
export const INTEGRATION_TYPES = [
  ...
  { id: 'scrutiny',   label: 'Scrutiny',    desc: 'Disk SMART health — URL is http://scrutiny:8080. No API key required — leave the field blank. Scrutiny runs unauthenticated by default.', category: 'Infrastructure' },
