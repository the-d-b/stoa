...
var panelFetchers = map[string]func(*sql.DB, map[string]interface{}) (interface{}, error){
	"sonarr": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchSonarrPanelData(db, cfg)
	},
	"radarr": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchRadarrPanelData(db, cfg)
	},
	"lidarr": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchLidarrPanelData(db, cfg)
	},
	...
	"truenas": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchTrueNASPanelData(db, cfg)
	},
	"proxmox": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchProxmoxPanelData(db, cfg)
	},
	"kuma": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) { return fetchKumaPanelData(db, cfg) },
	"gluetun": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchGluetunPanelData(db, cfg)
	},
	"opnsense": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchOPNsensePanelData(db, cfg)
	},
	"transmission": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchTransmissionPanelData(db, cfg)
	},
	"photoprism": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchPhotoPrismPanelData(db, cfg)
	},
	"authentik": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchAuthentikPanelData(db, cfg)
	},
	...
	"stocks": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchStocksPanelData(db, cfg)
	},
	"crypto": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchCryptoPanelData(db, cfg)
	},
	"readarr": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchReadarrPanelData(db, cfg)
	},
	"jellyfin": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchJellyfinPanelData(db, cfg)
	},
	"homeassistant": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) { return fetchHAPanelData(db, cfg) },
	"weather": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return FetchWeatherForIntegration(db, cfg)
	},
	"steam": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return FetchSteamForIntegration(db, cfg)
	},
	"overseerr": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchOverseerrPanelData(db, cfg)
	},
	"unraid": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchUnraidPanelData(db, cfg)
	},
	"omv": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) { return fetchOMVPanelData(db, cfg) },
	"synology": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchSynologyPanelData(db, cfg)
	},
	...
	"deluge": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchDelugePanelData(db, cfg)
	},
	"rutorrent": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchRTorrentPanelData(db, cfg)
	},
	"emby": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) { return fetchEmbyPanelData(db, cfg) },
	"jellystat": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchJellystatPanelData(db, cfg)
	},
	"tracearr": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchTracearrPanelData(db, cfg)
	},
	"immich": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchImmichPanelData(db, cfg)
	},
	"kavita": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchKavitaPanelData(db, cfg)
	},
	"komga": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) { return fetchKomgaPanelData(db, cfg) },
	"mylar3": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchMylar3PanelData(db, cfg)
	},
	"kapowarr": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchKapowarrPanelData(db, cfg)
	},
	"tranga": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchTrangaPanelData(db, cfg)
	},
	"audiobookshelf": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) { return fetchABSPanelData(db, cfg) },
	"navidrome": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchNavidromePanelData(db, cfg)
	},
	"pfsense": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchPfSensePanelData(db, cfg)
	},
	"openwrt": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchOpenWrtPanelData(db, cfg)
	},
	...
	"traefik": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchTraefikPanelData(db, cfg)
	},
	"cloudflare": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchCloudflarePanelData(db, cfg)
	},
	"pihole": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchPiHolePanelData(db, cfg)
	},
	"adguard": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchAdGuardPanelData(db, cfg)
	},
	"nextdns": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchNextDNSPanelData(db, cfg)
	},
	"nginxpm": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) { return fetchNPMPanelData(db, cfg) },
	"wgeasy": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchWGEasyPanelData(db, cfg)
	},
	"tailscale": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchTailscalePanelData(db, cfg)
	},
	"prometheus": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchPrometheusPanelData(db, cfg)
	},
	"grafana": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchGrafanaPanelData(db, cfg)
	},
	"autobrr": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchAutobrrrPanelData(db, cfg)
	},
	"bazarr": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchBazarrPanelData(db, cfg)
	},
	"prowlarr": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchProwlarrPanelData(db, cfg)
	},
	"frigate": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchFrigatePanelData(db, cfg)
	},
	"blueiris": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchBlueIrisPanelData(db, cfg)
	},
	"nextcloud": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchNextcloudPanelData(db, cfg)
	},
	"fireflyiii": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchFireflyPanelData(db, cfg)
	},
	"netbird": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchNetbirdPanelData(db, cfg)
	},
	"actualbudget": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchActualBudgetPanelData(db, cfg)
	},
	"scrutiny": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchScrutinyPanelData(db, cfg)
	},
	"paperless": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchPaperlessPanelData(db, cfg)
	},
	"mealie": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchMealiePanelData(db, cfg)
	},
	"grocy": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) { return fetchGrocyPanelData(db, cfg) },
	"ghostfolio": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchGhostfolioPanelData(db, cfg)
	},
	"coinbase": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchCoinbasePanelData(db, cfg)
	},
	"sabnzbd": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchSABnzbdPanelData(db, cfg)
	},
	"nzbget": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchNZBGetPanelData(db, cfg)
	},
	"tandoor": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchTandoorPanelData(db, cfg)
	},
	"lubelogger": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchLubeLoggerPanelData(db, cfg)
	},
	"tdarr": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) { return fetchTdarrPanelData(db, cfg) },
	"docspell": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchDocspellPanelData(db, cfg)
	},
	"romm": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) { return fetchRommPanelData(db, cfg) },
	"pterodactyl": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchPterodactylPanelData(db, cfg)
	},
	"maintainerr": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchMaintainerrPanelData(db, cfg)
	},
	"monica": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchMonicaPanelData(db, cfg)
	},
	"homebox": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchHomeboxPanelData(db, cfg)
	},
	"wger": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) { return fetchWgerPanelData(db, cfg) },
	"fittrackee": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchFittrackeePanelData(db, cfg)
	},
	"spotify": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchSpotifyPanelData(db, cfg)
	},
	"plexmusic": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchPlexMusicPanelData(db, cfg)
	},
	"lastfm": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchLastFmPanelData(db, cfg)
	},
	"strava": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchStravaPanelData(db, cfg)
	},
	"duolingo": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchDuolingoPanelData(db, cfg)
	},
	"github": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
	...
	"youtube": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchYouTubePanelData(db, cfg)
	},
	"kanban": func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) {
		return fetchKanbanPanelData(db, cfg)
	},
}
	...
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if cacheKey != "" && !hasOverride && !plexFiltered {
			if cached, ok := cacheGet(cacheKey); ok {
				logDebugf("CACHE", "panel hit %s (%s)", cacheKey, panelType)
				if haPanel {
		...
		if err != nil {
			logErrorf("PANEL", "%s fetch error: %v", panelType, err)
