...
var panelFetchers = map[string]func(*sql.DB, map[string]interface{}) (interface{}, error){
	...
	"mylar3":       func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) { return fetchMylar3PanelData(db, cfg) },
	"kapowarr":     func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) { return fetchKapowarrPanelData(db, cfg) },
	"tranga":       func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) { return fetchTrangaPanelData(db, cfg) },
	...
	"youtube":        func(db *sql.DB, cfg map[string]interface{}) (interface{}, error) { return fetchYouTubePanelData(db, cfg) },
