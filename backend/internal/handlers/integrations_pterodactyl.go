...
func fetchPterodactylPanelData(db *sql.DB, config map[string]interface{}) (*PterodactylPanelData, error) {
	integrationID := stringVal(config, "integrationId")
	if integrationID == "" {
		return nil, fmt.Errorf("pterodactyl: no integration configured")
	}
